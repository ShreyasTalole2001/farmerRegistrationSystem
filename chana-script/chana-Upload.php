...
if($_FILES["adharCardImage"]["name"]){
    ...
    $newfilename = './NondaniFiles/documents/'. $name ." " . $adharNo . "-Adhar-Card" .  '.' . end($temp);
...
if($_FILES["bankPassBookImage"]["name"]){
    ...
    $newfilename = './NondaniFiles/documents/'. $name. " " .$adharNo . "-Bank-Pass-Book" .  '.' . end($temp);
...
if($_FILES["satbara1"]["name"]){
    ...
    $newfilename = './NondaniFiles/satbara/'. $name. " " .$adharNo . "-712-1-" .  '.' . end($temp);
...
if($_FILES["satbara2"]["name"]){
    $temp = explode(".", $satbara1);
    $newfilename = './NondaniFiles/satbara/'. $name. " " . $adharNo . "-712-2-" .  '.' . end($temp);
...
if($_FILES["satbara3"]["name"]){
    $temp = explode(".", $satbara1);
    $newfilename = './NondaniFiles/satbara/'. $name. " " . $adharNo . "-712-3-" .  '.' . end($temp);
...
if($_FILES["satbara4"]["name"]){
    $temp = explode(".", $satbara1);
    $newfilename = './NondaniFiles/satbara/'. $name. " " .$adharNo . "-712-4-" .  '.' . end($temp);
...
if($_FILES["satbara5"]["name"]){
    $temp = explode(".", $satbara1);
    $newfilename = './NondaniFiles/satbara/'. $name. " " . $adharNo . "-712-5-" .  '.' . end($temp);
...
header('Location: ./success/sendSMS.php ');
